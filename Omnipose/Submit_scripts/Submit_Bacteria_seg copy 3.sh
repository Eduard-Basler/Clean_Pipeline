#!/bin/bash
#SBATCH --job-name=Omnipose_Bacteria_seg
...
#SBATCH --output=logs/Omnipose_Bacteria_seg/%j.out
#SBATCH --error=logs/Omnipose_Bacteria_seg/%j.err

# 1. Setup and Environment Check
cd $HOME/Imaging_Project_sciCORE/CLEAN/Pipeline_Final/Scripts/Cellpose_3

echo "Omnipose Bacteria Stitch"
